...
import { extractNumericPrice, siteUrl } from "@/lib/seo";
...
export default function ProductDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  const schemaImages = images.length ? images : product.image ? [product.image] : [];
  const productSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    name: product.name,
    image: schemaImages,
    description: product.description ?? `${product.name} by IVFODI Clothing.`,
    brand: {
      "@type": "Brand",
      name: "IVFODI Clothing",
    },
    offers: {
      "@type": "Offer",
      priceCurrency: "NGN",
